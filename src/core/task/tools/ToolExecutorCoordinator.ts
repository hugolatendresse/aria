...
import { SearchActuarialDocsToolHandler } from "./handlers/SearchActuarialDocsToolHandler"
...
export class ToolExecutorCoordinator {
	...
	private readonly toolHandlersMap: Record<ClineDefaultTool, (v: ToolValidator) => IToolHandler | undefined> = {
		...
		[ClineDefaultTool.RAG_SEARCH]: (v: ToolValidator) => new SearchActuarialDocsToolHandler(v),
	}
