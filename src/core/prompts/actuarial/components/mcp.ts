import { TemplateEngine } from "../../system-prompt/templates/TemplateEngine"

export const ACTUARIAL_RAG_TEMPLATE = `MCP SERVERS
...
export function renderActuarialRagTemplate(serversList: string = ""): string {
	return new TemplateEngine().resolve(ACTUARIAL_RAG_TEMPLATE, {
