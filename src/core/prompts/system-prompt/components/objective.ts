...
**ACTUARIAL DATA IMPLEMENTATION REQUIREMENT**: When users provide actuarial data (loss triangles, claims data, development patterns), follow the normal analysis and planning process below, but ensure that during the implementation/execution phase (step 2), you MUST use chainladder Triangle objects as the foundation for your solution.
