...
| `aria-dev.SidebarProvider.focus`                                                       | Opens and focuses the Cline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `aria-dev.SidebarProvider.focus`        | Opens the Cline sidebar panel |
